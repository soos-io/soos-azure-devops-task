...
TaskRunner.setInput("packageManagers", " rust, NuGet  , Npm ");
TaskRunner.setInput("branch", "ref/heads/main");
TaskRunner.setInput("outputFormat", "sarif");
...
exec[
  `node ./soos/node_modules/@soos-io/soos-sca/bin/index.js --apiKey="apikey123" --appVersion="0.0.0" --apiURL="https://dev-api.soos.io/api/" --branchName="ref/heads/main" --clientId="clientid123" --contributingDeveloperId="Unknown" --contributingDeveloperSource="EnvironmentVariable" --contributingDeveloperSourceName="Build.RequestedFor" --directoriesToExclude="**/node_modules/**,**/bin/**,**/obj/**,**/lib/**,**/soos/**" --filesToExclude="" --integrationName="AzureDevOps" --integrationType="Plugin" --logLevel="INFO" --onFailure="continue_on_failure" --outputFormat="SARIF" --packageManagers="rust,NuGet,Npm" --projectName="test-sca-azuretask" --sourceCodePath="C:\\temp\\"`
] = {
  code: 0,
